...
Repositório responsável pela Interface web do projeto 
...
Este repositório contém a aplicação frontend responsável por:
...
Este projeto consome a API disponível no repositório Backend.
